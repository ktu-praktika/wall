...
use Nfq\CarsBundle\Entity\Car;
use Nfq\CarsBundle\Form\CarType;
...
class CarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NfqCarsBundle:Car')->findAll();

        return $this->render('NfqCarsBundle:Car:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NfqCarsBundle:Car:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NfqCarsBundle:Car')->find($id);
        ...
        return $this->render('NfqCarsBundle:Car:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NfqCarsBundle:Car:edit.html.twig', array(
            'entity'      => $entity,
