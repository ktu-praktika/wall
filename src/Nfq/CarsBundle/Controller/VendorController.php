...
use Nfq\CarsBundle\Entity\Vendor;
use Nfq\CarsBundle\Form\VendorType;
...
class VendorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NfqCarsBundle:Vendor')->findAll();

        return $this->render('NfqCarsBundle:Vendor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NfqCarsBundle:Vendor:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NfqCarsBundle:Vendor:edit.html.twig', array(
            'entity'      => $entity,
